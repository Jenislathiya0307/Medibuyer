...
const PurchaseTemp = () => {
  return (
    <>
      <div className="bg-primary lg:py-24 py-12 relative overflow-hidden">
        ...
        <div className="container max-w-5xl mx-auto relative z-1">
          <div className="flex flex-col items-center justify-center text-center ">
            ...
            <Button color={"outlinewhite"} as={Link} to="/auth/auth1/register" target="_blank" className="mt-5 px-4 sm:w-auto w-full uppercase">
              Register
            </Button>
          </div>
        </div>
