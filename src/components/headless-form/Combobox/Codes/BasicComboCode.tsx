...
const BasicComboCode = () => {
  ...
  const [selected, setSelected] = useState<Person | null>(people[1]); // ✅ allow null
  ...
  return (
    <div className="mt-4">
      <Combobox
        value={selected}
        onChange={(value: Person | null) => setSelected(value)} // ✅ fix type
        onClose={() => setQuery("")}
      >
        <div className="relative">
          <ComboboxInput
            ...
            displayValue={(person: Person | null) => person?.name ?? ""} // ✅ safe null
